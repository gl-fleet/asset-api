...
namespace asset_allocation_api.Migrations
{
    ...
    [Migration("20250402091836_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.Asset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetCheckHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetCheckType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetCheckTypeSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetInspectionHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.Configuration", b =>
                {
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.DepartmentAssetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.DepartmentPersonnel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetPersonnelPermit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetPersonnelSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.Personnel", b =>
                {
                    b.Property<int>("PersonnelNo")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.TypeTraining", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.Asset", b =>
                {
                    b.HasOne("ot_api_asset_allocation.Context.AssetType", "AssetType")
                        .WithMany("Assets")
                        .HasForeignKey("AssetTypeId")
                        .HasConstraintName("FK_Asset_AssetType");

                    b.HasOne("ot_api_asset_allocation.Context.Department", "Department")
                        .WithMany("Assets")
                        .HasForeignKey("DepartmentId")
                        .HasConstraintName("FK_Asset_Department");

                    b.HasOne("ot_api_asset_allocation.Context.AssetAllocation", "LastAllocation")
                        .WithMany("Assets")
                        .HasForeignKey("LastAllocationId")
                        .HasConstraintName("Asset_AssetAllocation_Id_fk");

                    b.HasOne("ot_api_asset_allocation.Context.AssetCheckHistory", "LastMaintenance")
                        .WithMany("Assets")
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetAllocation", b =>
                {
                    b.HasOne("ot_api_asset_allocation.Context.Asset", "Asset")
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetCheckHistory", b =>
                {
                    b.HasOne("ot_api_asset_allocation.Context.AssetCheckType", "AssetCheckType")
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.AssetCheckTypeSetting", b =>
                {
                    ...
                    b.HasOne("ot_api_asset_allocation.Context.AssetCheckType", "CheckType")
                        .WithMany()
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetAllocation", b =>
                {
                    b.HasOne("ot_api_asset_allocation.Context.NonReturnableAssetPersonnelPermit", "Permit")
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetField", b =>
                {
                    b.HasOne("ot_api_asset_allocation.Context.NonReturnableAssetType", "AssetType")
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.NonReturnableAssetPersonnelSetting", b =>
                {
                    b.HasOne("ot_api_asset_allocation.Context.NonReturnableAssetField", "Field")
            ...
            modelBuilder.Entity("ot_api_asset_allocation.Context.TypeTraining", b =>
                {
                    ...
                    b.HasOne("ot_api_asset_allocation.Context.NonReturnableAssetType", "NonReturnableAssetType")
                        .WithMany("TypeTrainings")
